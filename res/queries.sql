...
INSERT INTO consumers.consumers VALUES ($1, st_makepoint($2, $3), default) RETURNING id;

-- name: update-consumer-name
UPDATE consumers.consumers SET name = $1 WHERE id = $2;

-- name: update-consumer-location
UPDATE consumers.consumers SET location = st_makepoint($1, $2) WHERE id = $3;

-- name: delete-consumer
DELETE FROM consumers.consumers WHERE id = $1;